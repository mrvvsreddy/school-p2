...
const TeacherProfileModal = ({ teacher, onClose }) => {
    ...
    const handleSave = () => {
        // Here you would typically trigger an API call to update the teacher
            ...
            <div className="bg-white rounded-3xl p-8 w-full max-w-5xl shadow-2xl transform transition-all scale-100 my-auto relative m-4 animate-in fade-in zoom-in duration-200">
                ...
                <div className="flex flex-col sm:flex-row gap-12">
                    ...
                    <div className="sm:w-1/3 flex flex-col items-center text-center">
                        <div className="w-48 h-48 rounded-full overflow-hidden ring-4 ring-blue-50 shadow-xl mb-6">
                        ...
                        <div className="w-full space-y-3">
                            <div className="bg-slate-50 rounded-2xl p-4">
                                <p className="text-xs text-slate-400 uppercase font-bold tracking-widest mb-1">Subject</p>
                                <p className="text-lg font-bold text-slate-800">{formData.subject}</p>
                            </div>
                            <div className="bg-slate-50 rounded-2xl p-4">
                                <p className="text-xs text-slate-400 uppercase font-bold tracking-widest mb-1">Department</p>
                                <p className="text-lg font-bold text-slate-800">{formData.department}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex-1 space-y-10 py-2">
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-3 gap-y-6 gap-x-8">
                                ...
                                <InputField label="Join Date" name="joinDate" type="date" value={formData.joinDate} />
