                ...
                <div className="flex flex-col lg:flex-row gap-16 items-center">
                    ...
                    <div className="lg:w-1/2">
                        <FadeIn delay={200}>
                            ...
                            {title && <h2 className="text-4xl font-serif font-bold mb-8 text-white">{title}</h2>}
                                ...
                                {requirements.map((req, idx) => {
                                    ...
                                    return (
                                        <div key={idx} className="flex items-center gap-4 p-4 bg-white/5 border border-white/10 rounded-lg hover:bg-white/10 transition-colors group">
                                            ...
                                            <div>
                                                {req.text && <span className="text-gray-200 font-bold text-sm block group-hover:text-white transition-colors">{req.text}</span>}
                                                {req.subtext && <span className="text-xs text-gray-500 group-hover:text-gray-400 transition-colors">{req.subtext}</span>}
                                            </div>
                                        </div>
                                    );
                                })}
