                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    <FadeIn delay={100} className="bg-white p-10 rounded-lg shadow-xl border-t-4 border-primary relative overflow-hidden group hover:-translate-y-2 transition-transform duration-500">
                        ...
                        <p className="text-gray-600 leading-relaxed text-lg">
                            To provide a transformative educational experience that empowers students to achieve academic excellence, develop strong character, and become responsible global citizens who contribute positively to society.
                        </p>
                    </FadeIn>
                    ...
                    <FadeIn delay={200} className="bg-white p-10 rounded-lg shadow-xl border-t-4 border-accent relative overflow-hidden group hover:-translate-y-2 transition-transform duration-500">
                        ...
                        <p className="text-gray-600 leading-relaxed text-lg">
                            To be a globally recognized institution enabling learners to thrive in a dynamic world through innovation, inclusivity, and a relentless pursuit of knowledge.
                        </p>
                    </FadeIn>
                </div>
            </div>
